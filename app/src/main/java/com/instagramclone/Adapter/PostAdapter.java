...
import com.instagramclone.Fragment.OtherUserFragment;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        if (post.getCaption().equals("")){
            ...
            viewHolder.description.setText(post.getCaption());
        }

        publisherInfo(viewHolder.image_profile, viewHolder.username, viewHolder.publisher, post.getPublisher());
        isLiked(post.getPostid(),viewHolder.like);
        numLike(viewHolder.likes,post.getPostid());
        ...
        viewHolder.image_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                ((FragmentActivity)mContext).getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new OtherUserFragment()).commit();
            }
        });
        ...
        viewHolder.save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (viewHolder.save.getTag().equals("save")){
                    ...
                    viewHolder.save.setImageResource(R.drawable.ic_save_black);
                    ...
                    viewHolder.save.setImageResource(R.drawable.ic_saved);
                }
            }
        });
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView image_profile, post_image, save, comment, like;
    ...
    private void getComments(String postid, final TextView comments){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String count_a = "There Are ";
                String count_b = " Comments";
                ...
                comments.setText(count_a+dataSnapshot.getChildrenCount()+count_b);
            }
    ...
    private void numLike(final TextView likes, String postid){
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Likes").child(postid);
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                likes.setText(dataSnapshot.getChildrenCount()+" "+ count);
            }
